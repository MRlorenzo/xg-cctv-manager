...
export default {
  ...
  methods: {
    async getRoutes() {
      ...
      * */
      let localRoutes = referenceRouteId(deepClone(asyncRoutes) , res.data )
    ...
    async handleEdit(scope) {
      ...
      let permissions = await this.getRoutesByRoleId(this.role.id)
      this.$nextTick(() => {
    ...
    async confirmRole() {
      ...
      let tree = this.generateTree(deepClone(this.routes), checkedKeys)
